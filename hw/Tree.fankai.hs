...
isBST (Leaf i) = True
isBST (Node a b c )
      | a > leftmost b && a < rightmost c = True
      | otherwise = False
-- isBST (Node 6 (Node 2 (Leaf 1) (Node 4 (Leaf 3) (Leaf 5))) (Node 8 (Leaf 1) (Leaf 9))) False
-- above case is not success
...
inBST n (Leaf i)
      | n == i = True
      | otherwise = False
inBST n (Node a b c) = elem n ( inorder b ++ [a] ++ inorder c)
